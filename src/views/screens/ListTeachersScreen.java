...
public class ListTeachersScreen extends ImagePanel {
    ...
    public ListTeachersScreen() {
        ...
        ImageIcon avatarIcon = new ImageIcon(getClass().getResource("/resources/Emoji_Professor_Triste.png"));
        ...
        JLabel titleLabel = new JLabel("Gerenciar Professores", SwingConstants.CENTER);
        ...
        String[] columnNames = {"ID", "Nome", "Qualificação", "Telefone", "Ação"};
